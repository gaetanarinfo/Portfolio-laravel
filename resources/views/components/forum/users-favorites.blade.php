                ...
                <div class="disputo-user-wrapper">
                    ...
                    <div id="bbp-user-body" class="disputo-user-right">
                        ...
                        <div id="bbp-user-topics-started" class="bbp-user-topics-started">
                            ...
                            <h2 class="entry-title">Sujets favoris du forum</h2>

                            <div class="bbp-user-section">

                                @if (count($topics_favorites) <= 0)
                                ...
                                @else
                                    <div class="bbp-pagination">
                                        ...
                                        <div class="bbp-pagination-count">
                                            Affichage de {{ count($topics_favorites) }} sujets - 1 à
                                            {{ count($topics_favorites) }} (sur
                                            {{ count($topics_favorites) }} au total)
                                        </div>
                                    ...
                                    <ul id="bbp-forum-0" class="bbp-topics">
                                        ...
                                        <li class="bbp-body">
                                            ...
                                            @foreach ($topics_favorites as $key => $data)
                                                @php
                                    ...
                                    <div class="bbp-pagination">
                                        ...
                                        <div class="bbp-pagination-count"> Affichage de {{ count($topics_favorites) }}
                                            sujets - 1 à
                                            {{ count($topics_favorites) }} (sur {{ count($topics_favorites) }} au
                                            total)
                                        </div>
