        ...
        <div class="apps-container wow fadeIn">
            ...
            <div class="row background-img"
                ...
                <div class="col-lg-12 h-s contain">
                    ...
                    <div class="col-lg-6 grid hide-mobile">
                    ...
                    <div class="col-lg-6 grid show-mobile">
                    ...
                    <div class="contain-btn">
                        ...
                        @else
                            @if (Auth::check())
                                <a href="{{ Route('free.apps', $projet_id->id) }}"
                                    class="btn btn-theme ml-0">Télécharger
                                    l'application</a>
                            @else
                                <a href="{{ Route('free.apps', $projet_id->id) }}"
                                    class="btn btn-theme ml-0">Télécharger
    ...
    <div class="apps-container apps-content">
        ...
        @if (session()->has('success'))
            <div class="alert alert-success">
                <i class="fa-solid fa-check mr-1"></i> <span
                    class="message-success">{{ session()->get('success') }}</span>
            </div>
        @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-7 mr-5 wow fadeIn">
                ...
                <p class="description mb-5">La sécurité, c'est d'abord comprendre comment les développeurs collectent et
                    ...
                    votre région et votre âge. Le développeur a fourni ces informations et peut les modifier
                    ultérieurement.
                </p>
                        ...
                        @if (Auth::check() && $user_verif_projet == null)
                            @for ($i = 1; $i <= 5; $i++)
                                @if ($projet->counter_avis !== 0)
                                    ...
                                    @else
                                        <div class="s-note active" data-note="{{ $i }}"
                                            data-toggle="modal" data-target="#modal-avis">
                                            <i class="fa-solid fa-star"></i>
                                        </div>
                                    @endif
                                @else
                            ...
                            <div class="grid-comments-all-avis">
                                ...
                                <div class="grid-comment">
                                    ...
                                    <div class="grid-img-text">
                                        ...
                                        <img src="{{ URL::asset('img/profil/' . $value->avatar) }}"
                                ...
                                <div class="grid-note">
                                    ...
                                    <div class="grid-note-in">
                                        ...
                                        <div class="grid-note-date">{{ date('d m Y', strtotime($value->created_at)) }}
                                        </div>
