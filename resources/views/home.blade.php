...
<head>
    ...
    <title>Portfolio Gaëtan Seigneur</title>
                ...
                <div class="collapse navbar-collapse" id="main-navbar">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a href="/" class="nav-link" data-animate="scrolling">Accueil</a>
                        </li>

                        <li class="nav-item">
                            <a href="#about" class="nav-link" data-animate="scrolling">À propos</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#contact" class="nav-link" data-animate="scrolling">Me contacter</a>
                        </li>
                    ...
                    <ul class="nav ml-auto">
                        <li class="nav-item">
                            <button class="btn btn-fab btn-theme no-shadow">{{ str_replace('_', '-', app()->getLocale()) }}</button>
                        </li>
                    </ul>
