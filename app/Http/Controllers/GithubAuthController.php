...
class GithubAuthController extends Controller
{
     ...
     * @return void
     */
    public function handleGithubCallback(Request $request, int $year = null)
    {
        try {
            ...
            if ($finduser) {
                ...
                if ($user->admin == 1) {
                    ...
                    return redirect()->route('dashboard', compact('user', 'commandes_graph', 'commandes_graph_refund', 'year', 'total_commandes', 'totals_commandes', 'total_commandes_refund', 'contacts'));
                } else {
                    return redirect()->route('dashboard', compact('user', 'contacts'));
                }
            }
        } catch (Exception $e) {
            dd($e->getMessage());
